                        ...
                        for (var j = 0; j < candidate.length; j++) {
                            ...
                            if (this.isRemovable(candid_candidate)) {
                                ...
                                if (this.needsEtcSign(active_index, farthest_index - 1)) {
                                    this.els.eq(farthest_index - 2).before('<li class="page-item disabled"><a class="page-link" href="">...</a></li>');
                                }
                                if (this.needsEtcSign(1, active_index)) {
                                    this.els.eq(1).after('<li class="page-item disabled"><a class="page-link" href="">...</a></li>');
                                }
                                return true;
                            }
                        }
